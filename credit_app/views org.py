    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            if serializer.data:
                ...
                return helper_function(None,"Failed to assign credit", status.HTTP_404_NOT_FOUND )
...
class show_item_purchased(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
         ...
         if serializer.is_valid():
             ...
             return helper_function(serializer.data, "Bill prepared successfully", status.HTTP_201_CREATED)
         else:
             helper_function(None, "Bill creation failed", status.HTTP_405_METHOD_NOT_ALLOWED)
...
class ItemViewset(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
         ...
         if serializer.is_valid():
             ...
             helper_function(None, "Failed_creation", status.HTTP_405_METHOD_NOT_ALLOWED)
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            if user:
                ...
                return helper_function(serializer.data, " logged in " , status.HTTP_200_OK)
